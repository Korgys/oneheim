...
public class EnemyFactory
{
    ...
    public static Enemy Create(EnemyId enemyId, int x, int y, int level)
    {
        return enemyId switch
        {
            ...
            EnemyId.ZombieCorpses => new ZombieCorpses(x, y, level),
            ...
            EnemyId.RatsNest => new RatsNest(x, y, level),
            EnemyId.AlphaWolf => new AlphaWolf(x, y, level),
            EnemyId.SpiderNest => new SpiderNest(x, y, level),
            ...
            EnemyId.OutlawSentinel => new OutlawSentinel(x, y, level),
            ...
            EnemyId.YoungPriest => new YoungPriest(x, y, level),
            ...
            EnemyId.HellStele => new HellStele(x, y, level),
