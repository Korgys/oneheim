...
public class EnemyFactoryTests
{
    ...
    [DataRow(EnemyId.ZombieCorpses, typeof(ZombieCorpses))]
    ...
    [DataRow(EnemyId.RatsNest, typeof(RatsNest))]
    [DataRow(EnemyId.AlphaWolf, typeof(AlphaWolf))]
    [DataRow(EnemyId.SpiderNest, typeof(SpiderNest))]
    ...
    [DataRow(EnemyId.OutlawSentinel, typeof(OutlawSentinel))]
    ...
    [DataRow(EnemyId.YoungPriest, typeof(YoungPriest))]
    ...
    [DataRow(EnemyId.HellStele, typeof(HellStele))]
